...
fpagesview.Lists["x_image_id"] = {"LinkField":"x_id","Ajax":null,"AutoFill":false,"DisplayFields":["x_title","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
<?php echo $pages->id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($pages->created_at->Visible) { // created_at ?>
	<tr id="r_created_at">
		<td><span id="elh_pages_created_at"><?php echo $pages->created_at->FldCaption() ?></span></td>
		<td<?php echo $pages->created_at->CellAttributes() ?>>
<span id="el_pages_created_at" class="control-group">
<span<?php echo $pages->created_at->ViewAttributes() ?>>
<?php echo $pages->created_at->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($pages->updated_at->Visible) { // updated_at ?>
	<tr id="r_updated_at">
		<td><span id="elh_pages_updated_at"><?php echo $pages->updated_at->FldCaption() ?></span></td>
		<td<?php echo $pages->updated_at->CellAttributes() ?>>
<span id="el_pages_updated_at" class="control-group">
<span<?php echo $pages->updated_at->ViewAttributes() ?>>
<?php echo $pages->updated_at->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($pages->image_id->Visible) { // image_id ?>
	<tr id="r_image_id">
		<td><span id="elh_pages_image_id"><?php echo $pages->image_id->FldCaption() ?></span></td>
...
<?php echo $pages->image_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($pages->post_id->Visible) { // post_id ?>
	<tr id="r_post_id">
		<td><span id="elh_pages_post_id"><?php echo $pages->post_id->FldCaption() ?></span></td>
...
<?php echo $pages->post_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($pages->isVisible->Visible) { // isVisible ?>
	<tr id="r_isVisible">
		<td><span id="elh_pages_isVisible"><?php echo $pages->isVisible->FldCaption() ?></span></td>
...
<?php echo $pages->isVisible->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
