...
class cimages_list extends cimages {
	...
	function BasicSearchSQL($Keyword) {
		...
		$sWhere = "";
		$this->BuildBasicSearchSQL($sWhere, $this->image_url, $Keyword);
		$this->BuildBasicSearchSQL($sWhere, $this->title, $Keyword);
		if (is_numeric($Keyword)) $this->BuildBasicSearchSQL($sWhere, $this->isVisible, $Keyword);
		return $sWhere;
	}
	...
	function SetUpSortOrder() {
		...
		if (@$_GET["order"] <> "") {
			...
			$this->UpdateSort($this->image_url); // image_url
...
<div class="accordion" id="fimageslistsrch_SearchGroup">
...
<div id="xsr_1" class="ewRow">
	...
	<input type="text" name="<?php echo EW_TABLE_BASIC_SEARCH ?>" id="<?php echo EW_TABLE_BASIC_SEARCH ?>" class="input-large" value="<?php echo ew_HtmlEncode($images_list->BasicSearch->getKeyword()) ?>" placeholder="<?php echo $Language->Phrase("Search") ?>">
...
<form name="fimageslist" id="fimageslist" class="ewForm form-horizontal" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="images">
...
<?php if ($images->image_url->Visible) { // image_url ?>
	<?php if ($images->SortUrl($images->image_url) == "") { ?>
		<td><div id="elh_images_image_url" class="images_image_url"><div class="ewTableHeaderCaption"><?php echo $images->image_url->FldCaption() ?></div></div></td>
	<?php } else { ?>
		<td><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $images->SortUrl($images->image_url) ?>',1);"><div id="elh_images_image_url" class="images_image_url">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $images->image_url->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($images->image_url->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($images->image_url->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></td>
	<?php } ?>
<?php } ?>		
<?php if ($images->title->Visible) { // title ?>
	<?php if ($images->SortUrl($images->title) == "") { ?>
		<td><div id="elh_images_title" class="images_title"><div class="ewTableHeaderCaption"><?php echo $images->title->FldCaption() ?></div></div></td>
	<?php } else { ?>
		<td><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $images->SortUrl($images->title) ?>',1);"><div id="elh_images_title" class="images_title">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $images->title->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($images->title->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($images->title->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></td>
	<?php } ?>
<?php } ?>		
<?php if ($images->isVisible->Visible) { // isVisible ?>
	<?php if ($images->SortUrl($images->isVisible) == "") { ?>
		<td><div id="elh_images_isVisible" class="images_isVisible"><div class="ewTableHeaderCaption"><?php echo $images->isVisible->FldCaption() ?></div></div></td>
	<?php } else { ?>
		<td><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $images->SortUrl($images->isVisible) ?>',1);"><div id="elh_images_isVisible" class="images_isVisible">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $images->isVisible->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($images->isVisible->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($images->isVisible->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></td>
	<?php } ?>
<?php } ?>		
<?php
...
<span>
<?php if ($images->image_url->LinkAttributes() <> "") { ?>
<?php if (!empty($images->image_url->Upload->DbValue)) { ?>
<img src="<?php echo $images->image_url->ListViewValue() ?>" alt="" style="border: 0;"<?php echo $images->image_url->ViewAttributes() ?>>
<?php } elseif (!in_array($images->CurrentAction, array("I", "edit", "gridedit"))) { ?>	
&nbsp;
<?php } ?>
<?php } else { ?>
<?php if (!empty($images->image_url->Upload->DbValue)) { ?>
...
<span<?php echo $images->title->ViewAttributes() ?>>
<?php echo $images->title->ListViewValue() ?></span>
<a id="<?php echo $images_list->PageObjName . "_row_" . $images_list->RowCnt ?>"></a></td>
	<?php } ?>
	<?php if ($images->isVisible->Visible) { // isVisible ?>
		<td<?php echo $images->isVisible->CellAttributes() ?>>
<span<?php echo $images->isVisible->ViewAttributes() ?>>
<?php echo $images->isVisible->ListViewValue() ?></span>
<a id="<?php echo $images_list->PageObjName . "_row_" . $images_list->RowCnt ?>"></a></td>
	<?php } ?>
<?php
...
<!--first page button-->
	...
	<a class="btn btn-small" type="button" href="<?php echo $images_list->PageUrl() ?>start=<?php echo $images_list->Pager->FirstButton->Start ?>"><i class="icon-step-backward"></i></a>
	<?php } else { ?>
...
<!--previous page button-->
	...
	<a class="btn btn-small" type="button" href="<?php echo $images_list->PageUrl() ?>start=<?php echo $images_list->Pager->PrevButton->Start ?>"><i class="icon-prev"></i></a>
	<?php } else { ?>
...
<!--next page button-->
	...
	<a class="btn btn-small" type="button" href="<?php echo $images_list->PageUrl() ?>start=<?php echo $images_list->Pager->NextButton->Start ?>"><i class="icon-play"></i></a>
	<?php } else { ?>
	<a class="btn btn-small" type="button" disabled="disabled"><i class="icon-play"></i></a>
	<?php } ?>
<!--last page button-->
	<?php if ($images_list->Pager->LastButton->Enabled) { ?>
	<a class="btn btn-small" type="button" href="<?php echo $images_list->PageUrl() ?>start=<?php echo $images_list->Pager->LastButton->Start ?>"><i class="icon-step-forward"></i></a>
	<?php } else { ?>
