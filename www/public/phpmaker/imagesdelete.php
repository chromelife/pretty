...
?>
<form name="fimagesdelete" id="fimagesdelete" class="ewForm form-horizontal" action="<?php echo ew_CurrentPage() ?>" method="post">
...
<?php if ($images->image_url->Visible) { // image_url ?>
		<td><span id="elh_images_image_url" class="images_image_url"><?php echo $images->image_url->FldCaption() ?></span></td>
<?php } ?>
<?php if ($images->title->Visible) { // title ?>
		<td><span id="elh_images_title" class="images_title"><?php echo $images->title->FldCaption() ?></span></td>
<?php } ?>
<?php if ($images->isVisible->Visible) { // isVisible ?>
		<td><span id="elh_images_isVisible" class="images_isVisible"><?php echo $images->isVisible->FldCaption() ?></span></td>
<?php } ?>
	</tr>
	</thead>
	<tbody>
...
<span id="el<?php echo $images_delete->RowCnt ?>_images_image_url" class="control-group images_image_url">
<span>
...
<span id="el<?php echo $images_delete->RowCnt ?>_images_title" class="control-group images_title">
...
<span id="el<?php echo $images_delete->RowCnt ?>_images_isVisible" class="control-group images_isVisible">
