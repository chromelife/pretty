...
?>
<form name="fimagesview" id="fimagesview" class="ewForm form-horizontal" action="<?php echo ew_CurrentPage() ?>" method="post">
...
<?php if ($images->image_url->Visible) { // image_url ?>
	<tr id="r_image_url">
		<td><span id="elh_images_image_url"><?php echo $images->image_url->FldCaption() ?></span></td>
...
<img src="<?php echo $images->image_url->ViewValue ?>" alt="" style="border: 0;"<?php echo $images->image_url->ViewAttributes() ?>>
...
<?php if ($images->title->Visible) { // title ?>
	<tr id="r_title">
		<td><span id="elh_images_title"><?php echo $images->title->FldCaption() ?></span></td>
...
<?php echo $images->title->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($images->isVisible->Visible) { // isVisible ?>
	<tr id="r_isVisible">
		<td><span id="elh_images_isVisible"><?php echo $images->isVisible->FldCaption() ?></span></td>
...
<?php echo $images->isVisible->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
