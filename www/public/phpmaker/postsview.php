...
<span id="el_posts_id" class="control-group">
...
<?php if ($posts->created_at->Visible) { // created_at ?>
	<tr id="r_created_at">
		<td><span id="elh_posts_created_at"><?php echo $posts->created_at->FldCaption() ?></span></td>
		<td<?php echo $posts->created_at->CellAttributes() ?>>
<span id="el_posts_created_at" class="control-group">
<span<?php echo $posts->created_at->ViewAttributes() ?>>
<?php echo $posts->created_at->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($posts->updated_at->Visible) { // updated_at ?>
	<tr id="r_updated_at">
		<td><span id="elh_posts_updated_at"><?php echo $posts->updated_at->FldCaption() ?></span></td>
		<td<?php echo $posts->updated_at->CellAttributes() ?>>
<span id="el_posts_updated_at" class="control-group">
<span<?php echo $posts->updated_at->ViewAttributes() ?>>
<?php echo $posts->updated_at->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php if ($posts->content->Visible) { // content ?>
	<tr id="r_content">
		<td><span id="elh_posts_content"><?php echo $posts->content->FldCaption() ?></span></td>
		<td<?php echo $posts->content->CellAttributes() ?>>
<span id="el_posts_content" class="control-group">
<span<?php echo $posts->content->ViewAttributes() ?>>
<?php echo $posts->content->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($posts->isVisible->Visible) { // isVisible ?>
	<tr id="r_isVisible">
		<td><span id="elh_posts_isVisible"><?php echo $posts->isVisible->FldCaption() ?></span></td>
...
<?php echo $posts->isVisible->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
